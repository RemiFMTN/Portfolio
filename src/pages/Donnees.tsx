export default function Donnees() {
  return (
    <main className="w-full px-4 py-10">
      <section className="mx-auto w-full max-w-3xl rounded-2xl border border-[var(--border)] bg-[var(--bg-card)] p-6 shadow-lg shadow-black/20 sm:p-8">
        <h1 className="text-2xl font-bold text-[var(--text)]">Politique de confidentialité</h1>

        <div className="mt-8 space-y-6 text-[var(--muted)]">
          <div>
            <h2 className="font-semibold text-[var(--text)]">Données collectées</h2>
          ...
          <div>
            <h2 className="font-semibold text-[var(--text)]">Finalité du traitement</h2>
          ...
          <div>
            <h2 className="font-semibold text-[var(--text)]">Base légale</h2>
            <p className="mt-2 leading-relaxed">Le traitement est basé sur le consentement de l'utilisateur.</p>
          </div>

          <div>
            <h2 className="font-semibold text-[var(--text)]">Destinataires</h2>
            <p className="mt-2 leading-relaxed">Les données collectées sont transmises uniquement à l'administrateur du site. Elle peuvent transiter par le service tiers: <a href="https://www.emailjs.com/" target="_blank" rel="noopener noreferrer" className="text-[var(--button)] underline">EmailJS</a>.</p>
          </div>
          
          <div>
            <h2 className="font-semibold text-[var(--text)]">Durée de conservation</h2>
          ...
          <div>
            <h2 className="font-semibold text-[var(--text)]">Droits des utilisateurs</h2>
            <p className="mt-2 leading-relaxed">
